      ...
      >
        {props.SidebarOpen ? (<div className="flex flex-col">
          ...
          <div className="flex items-center justify-left gap-3 px-3 py-2">
            ...
            <div className="">
              <div className="text-[#49484b] text-md">
                {UserData?.email}
              </div>
