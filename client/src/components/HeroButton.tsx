  ...
  return (
    <>
      <div className="flex justify-center items-center mt-[1.5rem]">
        ...
        <div className="flex bg-white gap-2 px-2 lg:px-3 py-1 lg:py-2 rounded-full text-[#848486] items-center">
          <div className="flex">
          {Words.map((word, index) =>
            <motion.p
              ...
              key={index}
              className="mr-0.5 lg:mr-0.75 text-[0.5rem] lg:text-[0.5rem] lg:text-[0.75rem]">
              {word}
            </motion.p>)}
            </div>
          <div className="flex bg-blue-400 text-[0.5rem] lg:text-[0.75rem] px-3 py-1 rounded-full text-white">
            <div>
              Generate
            </div>
            <div>
